...
/**
 * ProtectedRoute — strict auth guard.
 * Redirects to login if: no admin session, or JWT is expired.
 */
...
export default function App() {
  return (
    <AuthProvider>
      <BrowserRouter basename="/bma_ocsc_circular/admin">
        <Routes>
