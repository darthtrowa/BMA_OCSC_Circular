                ...
                <div className="space-y-4">
                  ...
                  {loadingUsers ? (
                    ...
                    <>
                      ...
                      {!autoUpAssignee && manualAssignees.length === 0 && (
                        <div className="p-4 border border-red-200 bg-red-50 rounded-xl text-red-700 text-sm flex flex-col gap-2 shadow-sm">
                          <div className="flex items-center gap-2 font-bold">
                            <i className="bx bx-error-circle text-xl"></i>
                            <span>ไม่พบรายชื่อผู้รับมอบหมาย / ผู้บังคับบัญชา</span>
                          </div>
                          <div className="text-red-600/80 ml-7">
                            ระบบไม่พบรายชื่อบุคคลในสายงานของคุณที่จะสามารถส่งต่อหรือมอบหมายงานได้ กรุณาติดต่อผู้ดูแลระบบเพื่อตรวจสอบการตั้งค่าโครงสร้างหน่วยงาน
                          </div>
                        </div>
                      )}
                    </>
