...
// Replace all legacy post routes (from submit-to-hr to the end of approve) with the single forward route
const startRouteToken = "/**\n * 1. COORDINATOR submits to HR_DIRECTOR (Legacy)";
const endRouteToken = "/**\n * 5. Reject (Send back)";

const startIndex = content.indexOf(startRouteToken);
const endIndex = content.indexOf(endRouteToken);
...
// Update the reject route signature in workflowRoutes
